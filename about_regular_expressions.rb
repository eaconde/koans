...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # when nothing matches the expression on its left (group)
  end
  ...
  # NOTE: using char class [] makes the engines look for the full range within the group (i.e. contains?)
  # while using alternation cycles one at a time
